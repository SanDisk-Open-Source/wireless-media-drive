/* $Id: testupnpdescgen.c,v 1.28 2012/03/05 20:36:17 nanard Exp $ */
/* MiniUPnP project
...
#ifdef QSI_NIMBUS
char manufacturer_name[]=OS_NAME;
char manufacturer_url[]=OS_URL;
char model_description[]=OS_NAME " router";
char model_name[]=OS_NAME " router";
char model_url[]=OS_URL;
#endif
