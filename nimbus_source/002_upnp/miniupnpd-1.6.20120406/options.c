...
#ifdef QSI_NIMBUS
   ,{UPNPMANUFACTURENAME,"manufacture_name"},
    {UPNPMANUFACTUREURL,"manufacture_url"},
    {UPNPMODELDESCRIPTION,"model_description"},
    {UPNPMODELNAME,"model_name"},
    {UPNPMODEURL,"model_url"}
#endif
};
