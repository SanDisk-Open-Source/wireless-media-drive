/* $Id: upnpglobalvars.c,v 1.28 2012/03/05 20:36:17 nanard Exp $ */
/* MiniUPnP project
...
#ifdef QSI_NIMBUS
char manufacturer_name[MANUFACTURER_NAME_MAX_LEN]=OS_NAME;
char manufacturer_url[MANUFACTURER_URL_MAX_LEN]=OS_URL ;
char model_description[MODEL_DESCRIPTION_MAX_LEN]=OS_NAME " router";
char model_name[MODEL_NAME_MAX_LEN]=OS_NAME " router";
char model_url[MODEL_URL_MAX_LEN]=OS_URL;
#endif
