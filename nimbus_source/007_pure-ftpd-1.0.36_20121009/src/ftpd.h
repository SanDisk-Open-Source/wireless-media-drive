...
//#define QSI_PATCHED
#ifdef QSI_PATCHED
/* Johnson.Lee patched for EWNULO by 20121007.
 * This patched is used to hidded specific folder for privated usage.
 * If the login account doesn't expect, the specific folder will be hidden.
 */
#define FTP_ANONYMOUS_ACCOUNT   "ftp"          // account for anonymous
#define FTP_ANONYMOUS_HOME      "/var/ftp"     // HOME of ftp

#define FTP_NOHIDDEN_ACCOUNT    "admin"     // only this account login can see HIDDEN_FOLDER
#define FTP_HIDDEN_PATH         "/var/ftp/storage"  // absolut path for hidden folder
//#define FTP_HIDDEN_FOLDER_NAME  "private"   // specific folder name under HIDDEN_PATH
