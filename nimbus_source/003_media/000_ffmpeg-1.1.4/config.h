...
#define FFMPEG_CONFIGURATION "--cross-prefix=arm-fsl-linux-gnueabi- --enable-cross-compile --arch=arm --enable-shared --prefix=/usr --enable-swscale --enable-pthreads --target-os=linux --enable-decoder=png --enable-encoder=png --enable-zlib"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/usr/share/ffmpeg"
#define AVCONV_DATADIR "/usr/share/ffmpeg"
#define CC_IDENT "gcc 4.4.4 (4.4.4_09.06.2010)"
